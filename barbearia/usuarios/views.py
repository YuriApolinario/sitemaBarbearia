...
# Importar o form padrão para cadastro de Barbeiros
...
# Classe de criação de Barbeiros
...
class UsuarioCreate(CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['titulo'] = "Cadastro de novos Barbeiros"
        context['botao'] = "Cadastrar"
        context['classeBotao'] = "btn-success"
        return context

    # Iremos adicionar um grupo ao Barbeiro cadastrado
    def form_valid(self, form):

        # Busca o grupo pelo nome "Usuario"
        # Primeiro faz a busca e depois chama o form valid para inserir o Barbeiro normalmente
        grupo = get_object_or_404(Group, name="Barbeiro")
        ...
        # Se o grupo existir
        if grupo:
            # Adiciona o grupo ao Barbeiro que foi criado nesse form
            self.object.groups.add(grupo)
            # Salva o Barbeiro de novo
            self.object.save()
